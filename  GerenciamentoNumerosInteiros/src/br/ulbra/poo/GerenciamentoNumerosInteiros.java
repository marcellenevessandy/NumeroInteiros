...
public class GerenciamentoNumerosInteiros {

    public ArrayList<Integer> numeros;

    public GerenciamentoNumerosInteiros() {
...
public String getNumerosImpares() {
...
public void atualizarLista(ArrayList<Integer> novaLista) {
    numeros = novaLista;
